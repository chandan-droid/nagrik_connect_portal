...
const mockGrievances = [
  {
    ...
    status: "in-progress",
    priority: "high",
    location: "MG Road, Sector 12, Delhi",
  ...
  {
    id: "3",
    ticketId: "NGP-2026-0003",
    title: "Pothole causing accidents on NH-48",
    description: "Large pothole on NH-48 near toll plaza. Multiple accidents reported.",
    category: "roads",
    status: "submitted",
    priority: "critical",
    location: "NH-48, Near Toll Plaza, Gurgaon",
    citizenName: "Mohammed Ali",
    citizenEmail: "mali@email.com",
  ...
  {
    id: "6",
    ticketId: "NGP-2026-0006",
    title: "Public hospital lacks medicines",
    ...
    citizenName: "Deepak Mishra",
    citizenEmail: "deepak@email.com",
    assignedOfficer: "Dr. Neha Kapoor",
